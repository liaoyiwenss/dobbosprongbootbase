...
jQuery("#choice1 li").click(function(){
    jQuery("#choice1 li").removeClass("checked");
    jQuery(this).addClass("checked");


})
jQuery("#choice2 li").click(function(){
    jQuery("#choice2 li").removeClass("checked");
    jQuery(this).addClass("checked");
